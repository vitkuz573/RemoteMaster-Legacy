...
namespace RemoteMaster.Updater.Common;
...
public abstract class UpdaterBase
{
    ...
    protected unsafe void MapNetworkDrive(string remotePath, string username, string password)
    {
    ...
    protected unsafe void CancelNetworkDrive(string remotePath)
    {
        fixed (char* pRemotePath = remotePath)
        {
    ...
    protected void DirectoryCopy(string sourceDirName, string destDirName, bool copySubDirs = true, bool overwriteExisting = false)
    {
