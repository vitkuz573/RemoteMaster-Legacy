...
public partial class HostConfigurationGenerator
{
    ...
    protected async override Task OnInitializedAsync()
    {
        ...
        _countries.Add("Congo, Democratic Republic of the", "CD");
        ...
        _countries.Add("United Kingdom of Great Britain and Northern Ireland", "GB");
        _countries.Add("United States Minor Outlying Islands", "UM");
        _countries.Add("United States of America", "US");
