...
public class RoleInitializationService(IServiceProvider serviceProvider) : IHostedService
{
    ...
    [
        ...
        new ApplicationClaim("Power", "RebootComputer", "Reboot Host", "Reboot the host"),
        new ApplicationClaim("Power", "ShutdownComputer", "Shutdown Host", "Shutdown the host"),
        new ApplicationClaim("Power", "WakeUpComputer", "Wake Up Host", "Wake up the host"),
