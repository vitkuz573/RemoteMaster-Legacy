...
namespace RemoteMaster.Server.Data.Migrations.ApplicationDbContextMigrations
{
    ...
    [Migration("20240906105050_UpdateCertificateRenewalTasks")]
    partial class UpdateCertificateRenewalTasks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RemoteMaster.Server.Aggregates.OrganizationAggregate.UserOrganizationalUnit", b =>
                {
            ...
            modelBuilder.Entity("RemoteMaster.Server.Aggregates.OrganizationAggregate.CertificateRenewalTask", b =>
                {
                    ...
                    b.HasOne("RemoteMaster.Server.Aggregates.OrganizationAggregate.Organization", null)
                        .WithMany("CertificateRenewalTasks")
            ...
            modelBuilder.Entity("RemoteMaster.Server.Aggregates.OrganizationAggregate.Organization", b =>
                {
                    b.Navigation("CertificateRenewalTasks");
