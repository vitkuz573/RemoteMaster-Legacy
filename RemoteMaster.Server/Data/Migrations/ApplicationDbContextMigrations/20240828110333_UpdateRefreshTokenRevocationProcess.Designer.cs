...
namespace RemoteMaster.Server.Data.Migrations.ApplicationDbContextMigrations
{
    ...
    [Migration("20240828110333_UpdateRefreshTokenRevocationProcess")]
    partial class UpdateRefreshTokenRevocationProcess
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RemoteMaster.Server.Entities.UserOrganization", b =>
                {
                    b.Property<Guid>("OrganizationId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RemoteMaster.Server.Entities.UserOrganizationalUnit", b =>
                {
            ...
            modelBuilder.Entity("RemoteMaster.Server.Aggregates.OrganizationAggregate.Organization", b =>
                {
                    b.OwnsOne("RemoteMaster.Server.ValueObjects.Address", "Address", b1 =>
                        {
            ...
            modelBuilder.Entity("RemoteMaster.Server.Entities.RefreshToken", b =>
                {
                    ...
                    b.OwnsOne("RemoteMaster.Server.ValueObjects.TokenRevocationInfo", "RevocationInfo", b1 =>
                        {
                    ...
                    b.OwnsOne("RemoteMaster.Server.ValueObjects.TokenValue", "TokenValue", b1 =>
                        {
                            b1.Property<int>("RefreshTokenId")
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("RemoteMaster.Server.Entities.UserOrganization", b =>
                {
                    ...
                    b.HasOne("RemoteMaster.Server.Entities.ApplicationUser", "ApplicationUser")
                        .WithMany("UserOrganizations")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
