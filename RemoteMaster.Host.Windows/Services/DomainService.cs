...
public class DomainService(IPowerService powerService) : IDomainService
{
    ...
    public void JoinToDomain(DomainJoinRequest domainJoinRequest)
    {
        ...
        var result = NetJoinDomain(null, domainJoinRequest.Domain, null, domainJoinRequest.UserCredential.UserName, domainJoinRequest.UserCredential.Password, NET_JOIN_DOMAIN_JOIN_OPTIONS.NETSETUP_JOIN_DOMAIN | NET_JOIN_DOMAIN_JOIN_OPTIONS.NETSETUP_ACCT_CREATE);
    ...
    public void UnjoinFromDomain(DomainUnjoinRequest domainUnjoinRequest)
    {
        ...
        var result = NetUnjoinDomain(null, domainUnjoinRequest.UserCredential.UserName, domainUnjoinRequest.UserCredential.Password, NETSETUP_ACCT_DELETE);
