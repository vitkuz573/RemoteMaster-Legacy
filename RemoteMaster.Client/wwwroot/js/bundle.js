(() => {
  ...
  var e = {
      584: (e, t, n) => {
        n.r(t), n.d(t, { MessagePackHubProtocol: () => O, VERSION: () => F });
        var o,
          r,
          i,
          s = 4294967295;
        ...
        var u = h ? new TextEncoder() : void 0,
          d = h
            ? 'undefined' != typeof process &&
              'force' !==
                (null ===
                  (r =
                    null === process || void 0 === process
                      ? void 0
                      : process.env) || void 0 === r
                  ? void 0
                  : r.TEXT_ENCODING)
              ? 200
              : 0
            : s,
          p = (null == u ? void 0 : u.encodeInto)
            ? function (e, t, n) {
                u.encodeInto(e, t.subarray(n));
              }
            : function (e, t, n) {
                t.set(u.encode(e), n);
              };
              ...
              return e instanceof Date
                ? (function (e) {
                    ...
                    if (n >= 0 && o >= 0 && n <= 17179869183) {
                      ...
                      return (
                        (r = new Uint8Array(8)),
                        (t = new DataView(r.buffer)).setUint32(
                          0,
                          (o << 2) | (3 & i)
                        ),
                        t.setUint32(4, s),
                    ...
                    return T(this, function (p) {
                      switch (p.label) {
                        case 0:
                          (i = !1), (p.label = 1);
                        case 1:
                          p.trys.push([1, 6, 7, 12]), (t = U(e)), (p.label = 2);
                        case 2:
                          return [4, t.next()];
                        case 3:
                  ...
                  return T(this, function (u) {
                    switch (u.label) {
                      case 0:
                        (n = t), (o = -1), (u.label = 1);
                      case 1:
                        u.trys.push([1, 13, 14, 19]), (r = U(e)), (u.label = 2);
                      case 2:
                        return [4, x(r.next())];
                      case 3:
                      ...
                      case 8:
                        return [3, 10];
                      case 9:
                        if (!((a = u.sent()) instanceof $)) throw a;
                        return [3, 10];
                      case 10:
              ...
              (e.prototype.doDecodeSync = function () {
                e: for (;;) {
                  ...
                  if (e >= 224) t = e - 256;
                    ...
                    if (201 !== e)
                      throw new m('Unrecognized type byte: '.concat(E(e)));
                  ...
                  for (var r = this.stack; r.length > 0; ) {
                    ...
                    if (0 === i.type) {
                      ...
                      if (1 === i.type) {
                        ...
                        if ('__proto__' === t)
                          throw new m('The key __proto__ is not allowed');
                        (i.key = t), (i.type = 2);
                        continue e;
                      }
                      if (
              ...
              (e.prototype.readArraySize = function () {
                ...
                switch (e) {
                  ...
                  default:
                    ...
                    throw new m('Unrecognized array type byte: '.concat(E(e)));
                }
              }),
        ...
        const N = new Uint8Array([145, B.C.Ping]);
        class O {
          constructor(e) {
            (this.name = 'messagepack'),
              (this.version = 1),
              (this.transferFormat = L.k.Binary),
              (this._errorResult = 1),
              (this._voidResult = 2),
            ...
            switch (o) {
              ...
              default:
                return (
                  t.log(
                    W.i.Information,
                    "Unknown message type '" + o + "' ignored."
                  ),
                  null
                );
            }
          ...
          _writeCompletion(e) {
            ...
            return j.write(n.slice());
          }
          _writeCancelInvocation(e) {
            const t = this._encoder.encode([
              B.C.CancelInvocation,
              e.headers || {},
              e.invocationId,
            ]);
            return j.write(t.slice());
      ...
      879: (e, t, n) => {
        ...
        async function m(e, t, n, o, r, i) {
          const s = {},
            [a, c] = S();
          (s[a] = c),
            e.log(
              p.i.Trace,
              `(${t} transport) sending data. ${y(r, i.logMessageContent)}.`
            );
          const h = v(r) ? 'arraybuffer' : 'text',
            l = await n.post(o, {
              content: r,
              headers: { ...s, ...i.headers },
              responseType: h,
        ...
        class C {
          ...
          log(e, t) {
            if (e >= this._minLevel) {
              const n = `[${new Date().toISOString()}] ${p.i[e]}: ${t}`;
              switch (e) {
                case p.i.Critical:
                case p.i.Error:
                  this.out.error(n);
        ...
        function S() {
          ...
          return (
            w.isNode && (e = 'User-Agent'),
            [e, I(f, E(), w.isNode ? 'NodeJS' : 'Browser', k())]
          );
        }
        function I(e, t, n, o) {
        ...
        class U extends d {
          constructor(e) {
            if ((super(), (this._logger = e), 'undefined' == typeof fetch)) {
              ...
              (this._jar = new (e('tough-cookie').CookieJar)()),
                ...
                (this._fetchType = e('fetch-cookie')(
                  this._fetchType,
                  this._jar
                ));
            } else
          ...
          async send(e) {
            if (e.abortSignal && e.abortSignal.aborted) throw new i();
            ...
            if (e.timeout) {
              ...
              a = setTimeout(() => {
                t.abort(),
                  this._logger.log(p.i.Warning, 'Timeout from HTTP request.'),
                  (n = new r());
              }, o);
            }
            ...
            if (!s.ok) {
              const e = await x(s, 'text');
              throw new o(e || s.statusText, s.status);
            }
            const c = x(s, e.responseType),
              h = await c;
            return new u(s.status, s.statusText, h);
          }
          getCookieString(e) {
            let t = '';
            return (
                ...
                ? new Promise((t, n) => {
                    ...
                    a &&
                      ...
                      (s.onload = () => {
                        e.abortSignal && (e.abortSignal.onabort = null),
                          s.status >= 200 && s.status < 300
                            ...
                            : n(
                                new o(
                                  s.response || s.responseText || s.statusText,
                                  s.status
                                )
                              );
                      }),
                      (s.onerror = () => {
                        this._logger.log(
                          p.i.Warning,
                          `Error from HTTP request. ${s.status}: ${s.statusText}.`
                        ),
                          n(new o(s.statusText, s.status));
                      }),
                      (s.ontimeout = () => {
                        this._logger.log(
                          p.i.Warning,
        ...
        class D extends d {
          constructor(e) {
            if ((super(), 'undefined' != typeof fetch || w.isNode))
        ...
        class $ {
          static write(e) {
            return `${e}${$.RecordSeparator}`;
          }
          static parse(e) {
            if (e[e.length - 1] !== $.RecordSeparator)
              throw new Error('Message is incomplete.');
            const t = e.split($.RecordSeparator);
            return t.pop(), t;
          }
        }
        ($.RecordSeparatorCode = 30),
          ($.RecordSeparator = String.fromCharCode($.RecordSeparatorCode));
        class R {
          writeHandshakeRequest(e) {
            return $.write(JSON.stringify(e));
          }
          parseHandshakeResponse(e) {
            let t, n;
            if (v(e)) {
              const o = new Uint8Array(e),
                r = o.indexOf($.RecordSeparatorCode);
        ...
        class B {
          ...
          subscribe(e) {
            return this.observers.push(e), new b(this, e);
          }
        }
        !(function (e) {
        ...
        class L {
          constructor(e, t, n, o) {
            (this._nextKeepAlive = 0),
              ...
              (this._connectionState = A.Disconnected),
          ...
          set baseUrl(e) {
            if (
              this._connectionState !== A.Disconnected &&
              this._connectionState !== A.Reconnecting
            )
              throw new Error(
          ...
          async _startWithStateTransitions() {
            if (this._connectionState !== A.Disconnected)
              return Promise.reject(
                new Error(
                  "Cannot start a HubConnection that is not in the 'Disconnected' state."
                )
              );
            (this._connectionState = A.Connecting),
              this._logger.log(p.i.Debug, 'Starting HubConnection.');
            try {
              await this._startInternal(),
                ...
                (this._connectionState = A.Connected),
          ...
          async _startInternal() {
            ...
            try {
              ...
              if (
                (this._logger.log(p.i.Debug, 'Sending handshake request.'),
          ...
          _stopInternal(e) {
            return this._connectionState === A.Disconnected
              ...
              ? (this._logger.log(
                ...
                this._stopPromise)
              : ((this._connectionState = A.Disconnecting),
                this._logger.log(p.i.Debug, 'Stopping HubConnection.'),
              ...
              for (const e of t)
                switch (e.type) {
                  ...
                  case M.C.Completion: {
                    ...
                    if (t) {
                      ...
                      try {
                        ...
                        this._logger.log(
                          p.i.Error,
                          `Stream callback threw error: ${T(e)}`
                        );
                      }
                    }
                    break;
                  ...
                  case M.C.Close: {
                    ...
                    const t = e.error
                      ? new Error(
                          'Server returned an error on close: ' + e.error
                        )
                      : void 0;
                    !0 === e.allowReconnect
          ...
          _processHandshakeResponse(e) {
            ...
            try {
              ...
              this._logger.log(p.i.Error, t);
              const n = new Error(t);
              throw (this._handshakeRejecter(n), n);
            }
            if (t.error) {
              const e = 'Server returned handshake error: ' + t.error;
              this._logger.log(p.i.Error, e);
              const n = new Error(e);
              throw (this._handshakeRejecter(n), n);
            }
            return (
              this._logger.log(p.i.Debug, 'Server handshake complete.'),
            ...
            if (
              ...
              e < 0 && (e = 0),
                (this._pingServerHandle = setTimeout(async () => {
                  if (this._connectionState === A.Connected)
                    try {
                      await this._sendMessage(this._cachedPingMessage);
                    } catch {
                      this._cleanupPingTimer();
          ...
          _connectionClosed(e) {
            this._logger.log(
              ...
              this._connectionState === A.Disconnecting
                ...
                : this._connectionState === A.Connected && this._reconnectPolicy
                ? this._reconnect(e)
                : this._connectionState === A.Connected &&
                  this._completeClose(e);
          }
          ...
          async _reconnect(e) {
            ...
            if (
              ...
              e
                ...
                : this._logger.log(p.i.Information, 'Connection reconnecting.'),
              ...
              if (this._connectionState !== A.Reconnecting)
            ...
            (this._callbacks = {}),
              Object.keys(t).forEach((n) => {
                ...
                try {
                  ...
                  this._logger.log(
                    p.i.Error,
                    `Stream 'error' callback called with '${e}' threw error: ${T(
                      t
                    )}`
                  );
                }
          ...
          _createInvocation(e, t, n, o) {
            if (n)
              return 0 !== o.length
                ...
                : { arguments: t, target: e, type: M.C.Invocation };
            {
                    ...
                    (o =
                      ...
                      (t = t.then(() =>
                        this._sendWithProtocol(
                          this._createCompletionMessage(n, o)
                        )
                      ));
                  },
                  next: (e) => {
                    t = t.then(() =>
                      this._sendWithProtocol(
                        this._createStreamItemMessage(n, e)
                      )
                    );
                  },
                });
          ...
          _createCancelInvocation(e) {
            return { invocationId: e, type: M.C.CancelInvocation };
          }
          _createStreamItemMessage(e, t) {
            return { invocationId: e, item: t, type: M.C.StreamItem };
          }
          _createCompletionMessage(e, t, n) {
            return t
              ? { error: t, invocationId: e, type: M.C.Completion }
              : { invocationId: e, result: n, type: M.C.Completion };
          }
        }
        const H = [0, 2e3, 1e4, 3e4, null];
        class W {
          constructor(e) {
            this._retryDelays = void 0 !== e ? [...e, null] : H;
          }
        ...
        class N extends d {
          ...
          _setAuthorizationHeader(e) {
            e.headers || (e.headers = {}),
              this._accessToken
                ? (e.headers[j.Authorization] = `Bearer ${this._accessToken}`)
                : this._accessTokenFactory &&
                  e.headers[j.Authorization] &&
                  delete e.headers[j.Authorization];
          }
          getCookieString(e) {
        ...
        class z {
          ...
          async connect(e, t) {
            ...
            t === O.k.Binary && (s.responseType = 'arraybuffer');
            const a = `${e}&_=${Date.now()}`;
            this._logger.log(
              p.i.Trace,
              `(LongPolling transport) polling: ${a}.`
            );
            ...
            200 !== c.statusCode
              ? (this._logger.log(
                ...
                (this._closeError = new o(c.statusText || '', c.statusCode)),
                (this._running = !1))
              : (this._running = !0),
        ...
        class q {
          ...
          async connect(e, t) {
            return (
              ...
              _.isRequired(t, 'transferFormat'),
              _.isIn(t, O.k, 'transferFormat'),
              this._logger.log(p.i.Trace, '(SSE transport) Connecting.'),
              (this._url = e),
              this._accessToken &&
                (e +=
                  (e.indexOf('?') < 0 ? '?' : '&') +
        ...
        class V {
          ...
          async connect(e, t) {
            ...
            return (
              ...
              _.isRequired(t, 'transferFormat'),
              _.isIn(t, O.k, 'transferFormat'),
              this._logger.log(p.i.Trace, '(WebSockets transport) Connecting.'),
              this._accessTokenFactory &&
                (n = await this._accessTokenFactory()),
              new Promise((o, r) => {
                let i;
                e = e.replace(/^http/, 'ws');
                ...
                i || (i = new this._webSocketConstructor(e)),
                  t === O.k.Binary && (i.binaryType = 'arraybuffer'),
                  (i.onopen = (t) => {
                    this._logger.log(
                      p.i.Information,
          ...
          send(e) {
            return this._webSocket &&
              ...
              ? (this._logger.log(
                  p.i.Trace,
                  `(WebSockets transport) sending data. ${y(
                    e,
                    this._logMessageContent
                  )}.`
                ),
        ...
        class K {
          constructor(e, t = {}) {
            ...
            w.isNode || 'undefined' == typeof WebSocket || t.WebSocket
              ? w.isNode && !t.WebSocket && o && (t.WebSocket = o)
              : (t.WebSocket = WebSocket),
              w.isNode || 'undefined' == typeof EventSource || t.EventSource
                ? w.isNode &&
                  !t.EventSource &&
                  void 0 !== r &&
                  (t.EventSource = r)
                : (t.EventSource = EventSource),
              (this._httpClient = new N(
                t.httpClient || new D(this._logger),
          ...
          async start(e) {
            if (
              ((e = e || O.k.Binary),
              _.isIn(e, O.k, 'transferFormat'),
              this._logger.log(
                p.i.Debug,
                `Starting connection with transfer format '${O.k[e]}'.`
              ),
            ...
            if ('Connected' !== this._connectionState) {
              ...
              return this._logger.log(p.i.Error, e), Promise.reject(new i(e));
            }
            this._connectionStarted = !0;
          }
          send(e) {
          ...
          async _startInternal(e) {
            ...
            try {
              if (this._options.skipNegotiation) {
                if (this._options.transport !== O.n.WebSockets)
                  throw new Error(
                    'Negotiation can only be skipped when using the WebSocket transport directly.'
                  );
                (this.transport = this._constructTransport(O.n.WebSockets)),
          ...
          async _getNegotiationResponse(e) {
            ...
            this._logger.log(p.i.Debug, `Sending negotiation request: ${i}.`);
            try {
              const e = await this._httpClient.post(i, {
                content: '',
          ...
          async _createTransport(e, t, n, o) {
            ...
            let h = n;
            for (const n of a) {
              const a = this._resolveTransportOrError(n, t, o);
              if (a instanceof Error)
                s.push(`${n.transport} failed:`), s.push(a);
              else if (this._isITransport(a)) {
                if (((this.transport = a), !h)) {
                  ...
                  r = this._createConnectUrl(e, h.connectionToken);
                }
                try {
                  return (
                    await this._startTransport(r, o),
                    void (this.connectionId = h.connectionId)
                  );
                } catch (e) {
                  if (
                    (this._logger.log(
                    ...
                    (h = void 0),
                    s.push(
                      new c(`${n.transport} failed: ${e}`, O.n[n.transport])
                    ),
                    'Connecting' !== this._connectionState)
                  ) {
                    const e =
                    ...
                    return (
                      this._logger.log(p.i.Debug, e), Promise.reject(new i(e))
                    );
                  }
                }
              }
          ...
          _resolveTransportOrError(e, t, n) {
            ...
            if (
              ...
              return (
                this._logger.log(
                  p.i.Debug,
                  `Skipping transport '${O.n[o]}' because it was disabled by the client.`
                ),
                new a(`'${O.n[o]}' is disabled by the client.`, o)
              );
            if (!(e.transferFormats.map((e) => O.k[e]).indexOf(n) >= 0))
              return (
                this._logger.log(
                  p.i.Debug,
                  `Skipping transport '${O.n[o]}' because it does not support the requested transfer format '${O.k[n]}'.`
                ),
                new Error(`'${O.n[o]}' does not support ${O.k[n]}.`)
              );
            if (
              (o === O.n.WebSockets && !this._options.WebSocket) ||
              (o === O.n.ServerSentEvents && !this._options.EventSource)
            )
              return (
                this._logger.log(
                  p.i.Debug,
                  `Skipping transport '${O.n[o]}' because it is not supported in your environment.'`
                ),
                new s(`'${O.n[o]}' is not supported in your environment.`, o)
              );
            this._logger.log(p.i.Debug, `Selecting transport '${O.n[o]}'.`);
            try {
          ...
          _resolveUrl(e) {
            if (
              ...
              return e;
            if (!w.isBrowser) throw new Error(`Cannot resolve '${e}'.`);
        ...
        class X {
          constructor(e) {
            (this._transport = e),
              ...
              (this._transportResult = new J()),
              (this._sendLoopPromise = this._sendLoop());
          }
          send(e) {
            return (
              this._bufferData(e),
              this._transportResult || (this._transportResult = new J()),
        ...
        const G = {
          trace: p.i.Trace,
          debug: p.i.Debug,
          info: p.i.Information,
          information: p.i.Information,
          warn: p.i.Warning,
          warning: p.i.Warning,
          error: p.i.Error,
          critical: p.i.Critical,
          none: p.i.None,
        };
        class Y {
          configureLogging(e) {
            if ((_.isRequired(e, 'logging'), void 0 !== e.log)) this.logger = e;
          ...
          withAutomaticReconnect(e) {
            ...
            return (
              e
                ? Array.isArray(e)
                  ? (this.reconnectPolicy = new W(e))
                  : (this.reconnectPolicy = e)
                : (this.reconnectPolicy = new W()),
              this
            );
          }
          build() {
            ...
            const t = new K(this.url, e);
            return L.create(
              t,
              this.logger || g.W.instance,
              this.protocol || new Q(),
      ...
      607: function (e, t, n) {
        ...
        window.setupSignalRConnection = function (e, t) {
          var n = new i.HubConnectionBuilder()
            .withUrl('http://'.concat(e, ':5076/hubs/control'), {
              skipNegotiation: !0,
              transport: i.HttpTransportType.WebSockets,
            })
            .withHubProtocol(new s.MessagePackHubProtocol())
            .configureLogging(i.LogLevel.Information)
            .build();
          n.on('ScreenUpdate', function (e) {
            if (e.IsEndOfImage) {
              var n = a.reduce(function (e, t) {
                ...
                i = String.fromCharCode.apply(
                  String,
                  r([], o(new Uint8Array(n)), !1)
                ),
                s = 'data:image/png;base64,' + window.btoa(i);
              t.invokeMethodAsync('UpdateScreenDataUrl', s), (a = []);
            } else a.push(Array.from(e.Data));
          }),
            n.start().catch(function (e) {
