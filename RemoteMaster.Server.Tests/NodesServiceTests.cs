...
public class NodesServiceTests : IDisposable
{
    ...
    public async Task AddNodesAsync_AddsNodes()
    {
        ...
        // Arrange
        var organization = new Organization { Id = Guid.NewGuid(), Name = "Org1", Country = "Country1", Locality = "Locality1", State = "State1" };
        context.Organizations.Add(organization);
        await context.SaveChangesAsync();

        var organizationalUnits = new List<OrganizationalUnit>
        {
            new() { Id = Guid.NewGuid(), Name = "OU1", OrganizationId = organization.Id },
            new() { Id = Guid.NewGuid(), Name = "OU2", OrganizationId = organization.Id }
        };
    ...
    public async Task AddNodesAsync_AddsComputers()
    {
        ...
        var organizationalUnit = new OrganizationalUnit { Id = Guid.NewGuid(), Name = "OU1", OrganizationId = organization.Id };
        context.OrganizationalUnits.Add(organizationalUnit);
        await context.SaveChangesAsync();

        var computers = new List<Computer>
        {
            new() { Id = Guid.NewGuid(), Name = "Comp1", IpAddress = "192.168.0.1", MacAddress = "00:00:00:00:00:01", ParentId = organizationalUnit.Id },
            new() { Id = Guid.NewGuid(), Name = "Comp2", IpAddress = "192.168.0.2", MacAddress = "00:00:00:00:00:02", ParentId = organizationalUnit.Id }
        };
